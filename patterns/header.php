	...
	<div class="wp-block-group alignfull is-style-header-row">
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><?php esc_html_e( 'Enquire', 'sd-theme-2026' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
