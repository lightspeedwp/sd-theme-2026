<?php
/**
 * Title: CTA — Not Sure Where To Go
 * Slug: sd-theme-2026/cta-not-sure-where-to-go
 * Description: The enquiry band live runs beneath its archives — a script heading over the two office numbers side by side, with the "Send us an Email" action beneath, on the warm-grey ground.
 * Categories: sd-theme-2026/call-to-action, sd-theme-2026/pages
 * Keywords: cta, enquiry, contact, phone, call, email, safari gurus, not sure
 * Viewport Width: 1200
...
<section class="wp-block-group alignfull is-style-tinted-page-section">
	...
	<!-- wp:heading {"textAlign":"center","className":"is-style-script-accent","style":{"elements":{"link":{"color":{"text":"var:preset|color|brand-500"}}}},"textColor":"brand-500","anchor":"h-not-sure-where-to-go"} -->
	<h2 class="wp-block-heading has-text-align-center is-style-script-accent has-brand-500-color has-text-color has-link-color" id="h-not-sure-where-to-go"><?php esc_html_e( 'Not sure where to go? Chat to one of our safari gurus!', 'sd-theme-2026' ); ?></h2>
	<!-- /wp:heading -->
