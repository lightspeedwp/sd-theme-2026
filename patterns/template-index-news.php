 ...
 * Slug: sd-theme-2026/template-index-news
...
<h1 class="wp-block-heading alignwide has-base-color has-text-color has-800-font-size" style="font-style:normal;font-weight:var(--wp--custom--font-weight--semi-bold);letter-spacing:0.03em"><?php esc_html_e( 'News', 'sd-theme-2026' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->
...
<!-- wp:column {"width":"20%","className":"sd-archive-sidebar","style":{"border":{"left":{"width":"0px","style":"none"},"top":[],"right":[],"bottom":[]},"spacing":{"padding":{"left":"var:preset|spacing|0"}}}} -->
<div class="wp-block-column sd-archive-sidebar" style="border-left-style:none;border-left-width:0px;padding-left:var(--wp--preset--spacing--0);flex-basis:20%"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"},"margin":{"top":"-30px"}},"position":{"type":"sticky","top":"0px"}},"layout":{"type":"constrained"}} -->
