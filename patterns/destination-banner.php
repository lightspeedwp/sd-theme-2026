 ...
 * Description: The destination single's opening banner — the hero banner configured for destinations: Tour Operator's banner_image_id photograph on a 360px floor with the destination title alone over it and no strapline. Over the photograph from 768px up; below it, on a neutral-200 plate, on phones.
 ...
 *
 * This is that pattern's markup — the 360px floor, `dimRatio: 100` against the
