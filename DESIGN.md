...
| `typography.fontFamilies` | **Provisional stacks, no bundled faces.** The live site uses Optima (headings, licensed), Open Sans (body), La Belle Aurore (script accent). No WOFF2 files are shipped — web font licensing is unresolved. |
